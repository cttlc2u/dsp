...
Python 3 because it is the version compatible with bootcamp materials, the HackerRank Python pre-work is configured for Python 3 only, and is the recommended version to use.
